...
function Library:Window(Args)
    local Title = Args.Title or "Gunter Hub"
    local Footer = Args.Footer or "BloxFruits Script | https://xynapse.lol"
    ...
    local Background_1 = Library:Create("Frame", {
        ...
        BackgroundColor3 = Color3.fromRGB(10, 10, 10), -- black
        Name = "Background",
        Parent = Xynpase_1,
    ...
    function Window:NewPage(Icon)
        ...
        local Asset_1 = Library:Create("ImageLabel", {
            ...
            ImageColor3 = Color3.fromRGB(255, 0, 0), -- red
            ImageTransparency = 0.5,
        })
        ...
        local Tab = {} do
            ...
            function Tab:Section(Args)
                ...
                local Light = Args.Light or Color3.fromRGB(220, 20, 20) -- red

                local Section_1 = Library:Create("Frame", {
                    AutomaticSize = Enum.AutomaticSize.Y,
                    BackgroundColor3 = Color3.fromRGB(16, 16, 16), -- dark section
                    Name = "Section",
                    Parent = NewPages_1,
                ...
                local Header_1 = Library:Create("Frame", {
                    BackgroundColor3 = Color3.fromRGB(20, 20, 20), -- dark header
                    LayoutOrder = -999,
                    Name = "Header",
                    Parent = Section_1,
                ...
                Library:Create("UIStroke", {
                    Color = Color3.fromRGB(255, 0, 0), -- red border
                    Thickness = 0.75,
                    Transparency = 0.95,
                    Parent = Section_1,
                })
                ...
                function Section:Toggle(Info)
                    ...
                    do
                        local Toggle_1 = Library:Create("Frame", {
                            BackgroundColor3 = Color3.fromRGB(30, 30, 30), -- dark off
                            Name = "Toggle",
                            Parent = Template.Right,
                        ...
                        local function OnChanged(value)
                            if value then
                                Onder_1.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
                                Toggle_1.BackgroundColor3 = Color3.fromRGB(220, 20, 20) -- red on
                                ...
                                Toggle_1.BackgroundColor3 = Color3.fromRGB(30, 30, 30) -- dark off
                    ...
                    do
                        ...
                        if Type == "Primary" then
                            Button_1 = Library:Create("Frame", {
                                BackgroundColor3 = Color3.fromRGB(220, 20, 20), -- red
                                Name = "Button",
                                Parent = Template.Right,
                ...
                function Section:Slider(Info)
                    ...
                    do
                        ...
                        local Value_1 = Library:Create("Frame", {
                            BackgroundColor3 = Color3.fromRGB(220, 20, 20), -- red fill
                            Name = "Value",
                            Parent = Slider_1,
                        ...
                        local White_1 = Library:Create("Frame", {
                            AnchorPoint = Vector2.new(0.5, 0.5),
                            BackgroundColor3 = Color3.fromRGB(220, 20, 20), -- red inside circle
                            Name = "White",
                            Parent = Circle_1,
                            Position = UDim2.new(0.5, 0, 0.5, 0),
                ...
                function Section:Dropdown(Info)
                    ...
                    local Value = Info.Value or "N/D" -- PT-BR
                    local IsMulti = typeof(Value) == 'table' and true or false
                    local Callback = Info.Callback

                    local Template = Library:Rows(Section_1, { Title = Title, Desc = "N/D" }) -- PT-BR
                    ...
                    do
                        ...
                        function Template:AddList(Name)
                            ...
                            local function OnValue(value)
                                if value then
                                    Library:Tween({ v = NewList_1, t = 0.2, s = "Linear", d = "Out", g = { BackgroundTransparency = 0.85 } }):Play() -- visible red
    ...
    do
        ...
        Library:Create("ImageLabel", {
            ...
            ImageColor3 = Color3.fromRGB(255, 0, 0), -- red logo
        })
